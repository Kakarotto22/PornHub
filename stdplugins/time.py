...
@borg.on(admin_cmd("وقت ?(.*)"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
    ...
    await borg.send_file(  # pylint:disable=E0602
        event.chat_id,
        required_file_name,
        caption="يعمل بواسطة : @channel22_22",
        # Courtesy: @ManueI15
    ...
    await event.edit("Created sticker in {} seconds, aare maa chuda na bc".format(time_taken_ms))
